...
class ContractrenewalController extends Controller
{
   ...
   // Get list
    ...
    public function actionSendForApproval($No)
    {
        ...
        $result = Yii::$app->navhelper->PortalWorkFlows($service,$data,'IanSendContractRenewalForApproval');
    ...
    public function actionCancelRequest($No)
    {
        ...
        $result = Yii::$app->navhelper->PortalWorkFlows($service,$data,'IanCancelContractApprovalRequest');
