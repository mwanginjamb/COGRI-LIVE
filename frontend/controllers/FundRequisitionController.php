...
class FundRequisitionController extends Controller
{
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout','signup','index','requestlist','create','update','delete','view'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
                    ...
                    [
                        'actions' => ['logout','index','requestlist','create','update','delete','view'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    public function actionCreate(){
        ...
        {
            return $this->redirect(['update','No' => Yii::$app->request->get('No') ]);
        }
        /*Do initial request */
    ...
    public function actionGetrequests(){
        $service = Yii::$app->params['ServiceName']['AllowanceRequestsPortal'];
        $filter = [
