            ...
            <div class="card-body">
                ...
                <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <?php //$form->field($model, 'No')->dropDownList($items, ['prompt' => 'Select Item...']) ?>
                            ...
                            <div class="col-md-6">
                                <?= $form->field($model, 'Duration_Of_Use')->textInput(['maxlength' => 3]) ?>

                               
                                <?= $form->field($model, 'Due_Replacement_Date')->textInput(['type' => 'date']) ?>

                                 <?= $form->field($model, 'Garage_Name')->textInput(['maxlength' => 150]) ?>

                                 <?= $form->field($model, 'Cost_of_Repair')->textInput(['type' => 'number']) ?>
