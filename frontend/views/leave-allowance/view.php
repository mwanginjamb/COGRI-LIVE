...
$this->title = 'Leave - '.$model->No;
$this->params['breadcrumbs'][] = ['label' => 'Leave Allowance List', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Leave Allowance Card', 'url' => ['view','No'=> $model->No]];
/** Status Sessions */
        ...
        <div class="col-md-12">
            <div class="card-info">
                <div class="card-header">
                    <h3>Leave Allowance Application Card </h3>
                </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Leave Application : <?= $model->No?></h3>
