               ...
               <div class="row">
                   <div class=" row col-md-12">
                       ...
                       <div class="col-md-6">
                          ...
                          <?= $form->field($model, 'Supervisor_Comments')->textArea(['rows'=> 2,'readonly'=> true, 'disabled'=>true]) ?>

                           <?= $form->field($model, 'Employee_Strengths')->textArea(['rows'=> 2,'readonly'=> true, 'disabled'=>true]) ?>
