                        ...
                        <div class=" row col-md-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <?= $form->field($model, 'Type_of_Fuel')->textInput(['disabled'=>true]) ?>
                                 <?= $form->field($model, 'Mileage_KMS')->textInput(['disabled'=>true]) ?>
                    ...
                    <?php if(is_array($model->lines)){ //show Lines ?>
                        <table class="table table-bordered">
                            ...
                            foreach($model->lines as $obj):
                                $updateLink = Html::a('<i class="fa fa-edit"></i>',['fuelline/update','No'=> $obj->Line_No],['class' => 'update-objective btn btn-outline-info btn-xs']);
