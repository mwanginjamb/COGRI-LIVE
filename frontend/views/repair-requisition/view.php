    ...
    <div class="col-md-4">
        ...
        <?= ($model->Requisition_Status == 'New')?Html::a('<i class="fas fa-paper-plane"></i> Send Approval Req',['send-for-approval'],['class' => 'btn btn-app submitforapproval',
            'data' => [
                ...
                'params'=>[
                    'Repair_Requisition_No'=> $model->Repair_Requisition_No,
                            ...
                            <table class="table table-bordered">
                                ...
                                foreach($model->lines as $obj):
                                    ...
                                    <tr>
                                        ...
                                        <td><?= !empty($obj->Cost_of_Repair)?number_format($obj->Cost_of_Repair):'Not Set' ?></td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel" style="position: absolute">Vehicle Repair Requisition</h4>
                </div>
