...
$this->title = 'Drug Issuance Requisition - '.$model->No;
$this->params['breadcrumbs'][] = ['label' => 'Drug Issuance', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => 'Drug Issuance Card', 'url' => ['view','No'=> $model->No]];
                    ...
                    <div class="row">
                        <div class=" row col-md-12">
                            <div class="col-md-6">
                                ...
                                <?= $form->field($model, 'Patient_Name')->textInput(['maxlength' =>  100,'readonly'=> true]) ?>
                                <?= $form->field($model, 'Patient_Card_No')->textInput(['maxlength' =>  100, 'readonly'=> true]) ?>
                                <?= $form->field($model, 'Patient_Diagnosis')->textInput(['maxlength' =>  100, 'readonly'=> true]) ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <?= $form->field($model, 'Global_Dimension_3_Code')->textInput(['readonly'=> true]) ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <?=($model->Status == 'New')?Html::a('<i class="fa fa-plus-square"></i> Add Line',['drug-issuanceline/create','No'=>$model->No],['class' => 'add-line btn btn-outline-info',
                        ]):'' ?>
                    </div>
                </div>
                    ...
                    <?php if(is_array($model->lines)){ //show Lines ?>
                        <table class="table table-bordered">
                            ...
                            foreach($model->lines as $obj):
                                $updateLink = Html::a('<i class="fa fa-edit"></i>',['drug-issuanceline/update','No'=> $obj->Line_No],['class' => 'update-objective btn btn-outline-info btn-xs']);
                                $deleteLink = Html::a('<i class="fa fa-trash"></i>',['drug-issuanceline/delete','Key'=> $obj->Key ],['class'=>'delete btn btn-outline-danger btn-xs']);
                                ?>
                                <tr>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel" style="position: absolute">Drug Issuance Management</h4>
                </div>
