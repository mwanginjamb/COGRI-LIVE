...
$this->params['breadcrumbs'][] = ['label' => 'Goals to Approve - Line Mgr. List', 'url' => ['index']];
?>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Goals to Approve - Line Mgr. List  &nbsp;    <?php Html::a('<i class="fa fa-plus-square"></i> Add New Appraisal',['create'],['class' => 'add-objective btn btn-outline-info btn-sm']) ?></h3>
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'probation/get-linemanagerobjlist',
            paging: true,
            columns: [
